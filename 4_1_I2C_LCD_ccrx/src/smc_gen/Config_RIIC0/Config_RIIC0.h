...
Macro definitions
***********************************************************************************************************************/
#define _F9_IIC0_SCL_LOW_LEVEL_PERIOD                          (0xF9U) /* SCL clock low-level period setting */
#define _F9_IIC0_SCL_HIGH_LEVEL_PERIOD                         (0xF9U) /* SCL clock high-level period setting */
