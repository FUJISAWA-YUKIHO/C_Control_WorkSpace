...
void R_Config_MTU4_Create(void)
{
    ...
    MTU.TOER.BYTE |= (_C2_MTU_OE4A_ENABLE | _D0_MTU_OE4C_ENABLE);
    MTU4.TCR.BYTE = _00_MTU_PCLK_1 | _40_MTU_CKCL_B;
    ...
    MTU4.TIORH.BYTE = _05_MTU_IOA_HL | _60_MTU_IOB_HH;
    MTU4.TIORL.BYTE = _05_MTU_IOC_HL | _60_MTU_IOD_HH;
    MTU4.TGRA = _07D0_TGRA4_VALUE;
    MTU4.TGRB = _095F_TGRB4_VALUE;
    MTU4.TGRC = _07D0_TGRC4_VALUE;
    MTU4.TGRD = _095F_TGRD4_VALUE;
