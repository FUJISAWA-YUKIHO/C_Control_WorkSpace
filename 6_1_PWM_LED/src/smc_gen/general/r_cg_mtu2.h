...
#define _00_MTU_TVCOR_SKIP_COUNT_0      (0x00U) /* Does not perform TCIV4 interrupt skipping */
#define _01_MTU_TVCOR_SKIP_COUNT_1      (0x01U) /* Sets the TCIV4 interrupt skipping count to 1 */
#define _02_MTU_TVCOR_SKIP_COUNT_2      (0x02U) /* Sets the TCIV4 interrupt skipping count to 2 */
#define _03_MTU_TVCOR_SKIP_COUNT_3      (0x03U) /* Sets the TCIV4 interrupt skipping count to 3 */
#define _04_MTU_TVCOR_SKIP_COUNT_4      (0x04U) /* Sets the TCIV4 interrupt skipping count to 4 */
#define _05_MTU_TVCOR_SKIP_COUNT_5      (0x05U) /* Sets the TCIV4 interrupt skipping count to 5 */
#define _06_MTU_TVCOR_SKIP_COUNT_6      (0x06U) /* Sets the TCIV4 interrupt skipping count to 6 */
#define _07_MTU_TVCOR_SKIP_COUNT_7      (0x07U) /* Sets the TCIV4 interrupt skipping count to 7 */
/* TGIA3 Interrupt Skipping Count Setting (T3ACOR[2:0]) */
#define _00_MTU_TACOR_SKIP_COUNT_0      (0x00U) /* Does not perform TGIA3 interrupt skipping */
#define _10_MTU_TACOR_SKIP_COUNT_1      (0x10U) /* Sets the TGIA3 interrupt skipping count to 1 */
#define _20_MTU_TACOR_SKIP_COUNT_2      (0x20U) /* Sets the TGIA3 interrupt skipping count to 2 */
#define _30_MTU_TACOR_SKIP_COUNT_3      (0x30U) /* Sets the TGIA3 interrupt skipping count to 3 */
#define _40_MTU_TACOR_SKIP_COUNT_4      (0x40U) /* Sets the TGIA3 interrupt skipping count to 4 */
#define _50_MTU_TACOR_SKIP_COUNT_5      (0x50U) /* Sets the TGIA3 interrupt skipping count to 5 */
#define _60_MTU_TACOR_SKIP_COUNT_6      (0x60U) /* Sets the TGIA3 interrupt skipping count to 6 */
#define _70_MTU_TACOR_SKIP_COUNT_7      (0x70U) /* Sets the TGIA3 interrupt skipping count to 7 */
/* T4VEN */
#define _00_MTU_TVEN_DISABLE            (0x00U) /* TCIV4 interrupt skipping disabled */
#define _08_MTU_TVEN_ENABLE             (0x08U) /* TCIV4 interrupt skipping enabled */
/* T3AEN */
#define _00_MTU_TAEN_DISABLE            (0x00U) /* TGIA3 interrupt skipping disabled */
#define _80_MTU_TAEN_ENABLE             (0x80U) /* TGIA3 interrupt skipping enabled */
